...
INSERT INTO `vtst_admin` (`id`, `username`, `password`, `create_time`, `groupid`, `status`) VALUES
(2, 'admin', '$2y$10$EPj9AulYaxkp3uKhuAVBZOJX3KoeaYztNiiJ56YQ5NuhgBdSfkVp.', 1639449394, 1, 1),
(3, 'aaaaaa', '$2y$10$fWuXzt3Hooq01R2W1kY4Q.k77M1VWDE7J4R3zl/SYwAH9TRuJqyHC', 1639449715, NULL, 0);
...
(1, '炒鸡管理员', 1, '#', '是是是aaa', NULL, 1639380703),
(5, 'b', 1, '', 'b', NULL, NULL),
...
CREATE TABLE `vtst_auth_rule` (
  ...
  `content` char(100) DEFAULT '' COMMENT '简介',
  `pid` int(11) NOT NULL COMMENT '父栏目ID',
  `css` varchar(100) DEFAULT NULL COMMENT 'icon样式',
...
INSERT INTO `vtst_auth_rule` (`id`, `title`, `status`, `level`, `content`, `pid`, `css`, `sort`, `path`) VALUES
(1, '用户管理', 1, 0, '', 0, 'el-icon-setting', 1, NULL),
(2, '用户列表', 1, 1, '', 1, '', 1, 'admin'),
(3, '权限管理', 1, 0, '', 0, '', 1, NULL),
(4, '角色列表', 1, 1, '', 3, '', 1, 'roles'),
(5, '权限列表', 1, 1, '', 3, '', 1, 'auth'),
(6, '文章管理', 1, 0, '', 0, '', 1, NULL),
(7, '文章列表', 1, 1, '', 6, '', 1, 'list'),
(8, '系统管理', 1, 0, '', 0, '', 1, NULL),
(9, '系统列表', 1, 1, '', 8, '', 1, 'system'),
(10, '添加角色', 1, 2, '', 4, '', 1, NULL);
...
(3, 'admin', '$2y$10$jBnKG9d9.ckE6rVKoVD2wOm9ziqiacawQjpRykL24g8LGlaHYh8Vu', 1639209553, NULL, 1, 1),
